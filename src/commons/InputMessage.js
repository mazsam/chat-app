  ...
  return (
    ...
    <div className="relative flex">
       <input
        ...
        type="text" placeholder="Tulis pesan disini" className="w-full focus:outline-none focus:placeholder-gray-400 text-gray-600 placeholder-gray-600 pl-12 bg-gray-200 rounded-md py-3" />
       <div className="absolute right-0 items-center inset-y-0">
          ...
          {
            loading ?  <span className="font-bold">Sending</span> :
            <>
